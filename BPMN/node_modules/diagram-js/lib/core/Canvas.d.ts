...
type ConnectionLike = import('diagram-js/lib/core/Types').ConnectionLike;
type RootLike = import('diagram-js/lib/core/Types').RootLike;
type ParentLike = import('diagram-js/lib/core/Types').ParentLike;
type ShapeLike = import('diagram-js/lib/core/Types').ShapeLike;
...
type ScrollDelta = import('diagram-js/lib/util/Types').ScrollDelta;
