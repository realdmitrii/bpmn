...
/**
 * @typedef {import('diagram-js/lib/core/Types').ConnectionLike} ConnectionLike
 * @typedef {import('diagram-js/lib/core/Types').RootLike} RootLike
 * @typedef {import('diagram-js/lib/core/Types').ParentLike } ParentLike
 * @typedef {import('diagram-js/lib/core/Types').ShapeLike} ShapeLike
 *
 * @typedef { {
 ...
 * @typedef {import('diagram-js/lib/util/Types').ScrollDelta} ScrollDelta
 */
