...
export default class MoveHelper {
   ...
   * @return
   */
  moveRecursive<T extends import("diagram-js/lib/model/Types").ElementLike>(elements: T[], delta: Point, newParent: Shape): T[];
...
import MoveClosure from 'diagram-js/lib/features/modeling/cmd/helper/MoveClosure';
