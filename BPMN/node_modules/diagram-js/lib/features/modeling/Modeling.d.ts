 ...
 *
 */
export default class Modeling<T extends import("diagram-js/lib/model/Types").Connection = import("diagram-js/lib/model/Types").Connection, U extends import("diagram-js/lib/model/Types").Element = import("diagram-js/lib/model/Types").Element, V extends import("diagram-js/lib/model/Types").Label = import("diagram-js/lib/model/Types").Label, W extends import("diagram-js/lib/model/Types").Parent = import("diagram-js/lib/model/Types").Parent, X extends import("diagram-js/lib/model/Types").Shape = import("diagram-js/lib/model/Types").Shape> {
...
type Connection = import('diagram-js/lib/model/Types').Connection;
type Parent = import('diagram-js/lib/model/Types').Parent;
type Shape = import('diagram-js/lib/model/Types').Shape;
type Label = import('diagram-js/lib/model/Types').Label;
...
type CommandHandlerConstructor = import('diagram-js/lib/command/CommandStack').CommandHandlerConstructor;
...
export type ModelingDistributeGroup<U extends import("diagram-js/lib/model/Types").Element> = {
    elements: U[];
    range: {
        min: number;
        max: number;
