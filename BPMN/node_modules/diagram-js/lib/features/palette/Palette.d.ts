...
type PaletteEntries = import('diagram-js/lib/features/palette/PaletteProvider').PaletteEntries;
type PaletteProvider = import('diagram-js/lib/features/palette/PaletteProvider').default;
