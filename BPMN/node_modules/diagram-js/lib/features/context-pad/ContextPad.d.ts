...
export type ContextPadTarget<ElementType extends import("diagram-js/lib/model/Types").Element = import("diagram-js/lib/model/Types").Element> = ElementType | ElementType[];
