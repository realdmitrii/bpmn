...
type BendpointMove = import('diagram-js/lib/features/bendpoints/BendpointMove').default;
type Canvas = import('diagram-js/lib/core/Canvas').default;
type ConnectionSegmentMove = import('diagram-js/lib/features/bendpoints/ConnectionSegmentMove').default;
