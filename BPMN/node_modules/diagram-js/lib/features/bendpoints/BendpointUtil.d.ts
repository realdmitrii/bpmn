...
export function getConnectionIntersection(canvas: any, waypoints: any, event: any): import("diagram-js/lib/util/LineIntersection").Intersection;
...
type Connection = import('diagram-js/lib/core/Types').ConnectionLike;
