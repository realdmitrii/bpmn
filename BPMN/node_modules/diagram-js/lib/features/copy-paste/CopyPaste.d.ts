...
export default class CopyPaste {
  ...
  paste(context?: {
      ...
      point?: Point;
      hints?: any;
  }): import("diagram-js/lib/model/Types").Element[];

  createConnection(attrs: any): import("diagram-js/lib/model/Types").Connection;
  createLabel(attrs: any): import("diagram-js/lib/model/Types").Label;
  createShape(attrs: any): import("diagram-js/lib/model/Types").Shape;
...
type Element = import('diagram-js/lib/core/Types').ElementLike;
type Shape = import('diagram-js/lib/core/Types').ShapeLike;
type Point = import('diagram-js/lib/util/Types').Point;
type Canvas = import('diagram-js/lib/core/Canvas').default;
type Clipboard = import('diagram-js/lib/features/clipboard/Clipboard').default;
...
type Mouse = import('diagram-js/lib/features/mouse/Mouse').default;
