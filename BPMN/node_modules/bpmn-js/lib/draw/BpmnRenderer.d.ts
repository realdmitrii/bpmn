...
export default class BpmnRenderer extends BaseRenderer {
   ...
   * @param priority
   */
  constructor(config: BpmnRendererConfig, eventBus: import('diagram-js/lib/core/EventBus').default, styles: import('diagram-js/lib/draw/Styles').default, pathMap: import('bpmn-js/lib/draw/PathMap').default, canvas: import('diagram-js/lib/core/Canvas').default, textRenderer: import('bpmn-js/lib/draw/TextRenderer').default, priority?: number);
