...
type BpmnReplace = import('bpmn-js/lib/features/replace/BpmnReplace').default;
export type Rules = any;
export type Translate = typeof import("diagram-js/lib/i18n/translate/translate").default;
type ModdleCopy = import('bpmn-js/lib/features/copy-paste/ModdleCopy').default;
type Element = import('bpmn-js/lib/model/Types').Element;
type Moddle = import('bpmn-js/lib/model/Types').Moddle;
