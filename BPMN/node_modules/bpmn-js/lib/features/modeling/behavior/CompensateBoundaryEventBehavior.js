...
import { hasEventDefinition, isEventSubProcess } from 'bpmn-js/lib/util/DiUtil';
 ...
 * @param {import('bpmn-js/lib/features/modeling/Modeling').default} modeling
 * @param {import('bpmn-js/lib/features/rules/BpmnRules').default} bpmnRules
 */
