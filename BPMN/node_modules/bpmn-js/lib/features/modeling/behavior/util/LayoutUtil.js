import {
  ...
  rotateVector,
  getAngle
} from 'bpmn-js/lib/features/modeling/behavior/util/GeometricUtil';

import {
  getAttachment
} from 'bpmn-js/lib/features/modeling/behavior/util/LineAttachmentUtil';
 ...
 *
 * @typedef {import('bpmn-js/lib/features/modeling/behavior/util/LineAttachmentUtil').Attachment} Attachment
 *
 * @typedef { {
 *   point: Point;
 *   delta: Point;
