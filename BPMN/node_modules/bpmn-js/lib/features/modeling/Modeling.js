...
/**
 * @typedef {import('bpmn-js/lib/features/rules/BpmnRules').default} BpmnRules
 * @typedef {import('diagram-js/lib/command/CommandStack').default} CommandStack
 * @typedef {import('bpmn-js/lib/features/modeling/ElementFactory').default} ElementFactory
 * @typedef {import('diagram-js/lib/core/EventBus').default} EventBus
 *
 * @typedef {import('diagram-js/lib/features/modeling/Modeling').ModelingHints} ModelingHints
 *
 * @typedef {import('bpmn-js/lib/model/Types').Connection} Connection
 * @typedef {import('bpmn-js/lib/model/Types').Element} Element
 * @typedef {import('bpmn-js/lib/model/Types').Label} Label
 * @typedef {import('bpmn-js/lib/model/Types').Parent} Parent
 * @typedef {import('bpmn-js/lib/model/Types').Root} Root
 ...
 *
 * @typedef {import('bpmn-js/lib/util/Types').Colors} Colors
 *
 * @typedef { {
 *   removeShape?: boolean;
 * } } UpdateLabelHints
