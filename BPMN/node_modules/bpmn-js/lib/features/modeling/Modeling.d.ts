 ...
 *
 */
export default class Modeling<T extends import("bpmn-js/lib/model/Types").Connection = import("bpmn-js/lib/model/Types").Connection, U extends import("bpmn-js/lib/model/Types").Element = import("bpmn-js/lib/model/Types").Element, V extends import("bpmn-js/lib/model/Types").Label = import("bpmn-js/lib/model/Types").Label, W extends import("bpmn-js/lib/model/Types").Parent = import("bpmn-js/lib/model/Types").Parent, X extends import("bpmn-js/lib/model/Types").Shape = import("bpmn-js/lib/model/Types").Shape> extends BaseModeling<T, U, V, W, X> {
  /**
   * @param eventBus
...
type BpmnRules = import('bpmn-js/lib/features/rules/BpmnRules').default;
...
type Connection = import('bpmn-js/lib/model/Types').Connection;
type Element = import('bpmn-js/lib/model/Types').Element;
type Label = import('bpmn-js/lib/model/Types').Label;
type Parent = import('bpmn-js/lib/model/Types').Parent;
type Root = import('bpmn-js/lib/model/Types').Root;
...
type Colors = import('bpmn-js/lib/util/Types').Colors;
